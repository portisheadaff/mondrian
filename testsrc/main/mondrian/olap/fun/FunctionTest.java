...
public class FunctionTest extends FoodMartTestCase {
    ...
    public void testIifStringEqualNum() {
        ...
        assertQueryReturns(
            ...
            + "member [Measures].[Numeric] as 'Iif([Measures].[String] = 0, NULL, 42)'\n"
            + "select \n"
            + "{[Measures].[String], [Measures].[Numeric]} on columns\n"
            + "from Sales",
            "Axis #0:\n"
            + "{}\n"
            + "Axis #1:\n"
        ...
        assertQueryReturns(
            "with \n"
            + "member [Measures].[String] as '[Product].[Food].Member_Caption' \n"
            + "member [Measures].[Numeric] as 'Iif(0 = [Measures].[String], NULL, 42)'\n"
            + "select \n"
            + "{[Measures].[String], [Measures].[Numeric]} on columns\n"
            + "from Sales",
            "Axis #0:\n"
        ...
        assertQueryReturns(
            ...
            + "member [Measures].[String] as '[Product].[Food].Member_Caption' \n"
            + "member [Measures].[Numeric] as 'Iif(0 = [Measures].[String], NULL, 42)'\n"
            + "member [Measures].[FinalString] as 'Iif(\"test\" = [Measures].[Numeric], \"a\", \"b\")'\n"
            + "select \n"
            + "{[Measures].[String], [Measures].[FinalString]} on columns\n"
            + "from Sales",
            "Axis #0:\n"
            + "{}\n"
            + "Axis #1:\n"
            + "{[Measures].[String]}\n"
            + "{[Measures].[FinalString]}\n"
            + "Row #0: Food\n"
            + "Row #0: b\n");

        // This fails due to the 'test'=0
        assertExprReturns("IIf('0' = 0, 1, 2)", "2");
        // This fails due to the 'test'=0
        assertExprReturns("IIf(0 = 'test', 1, 2)", "2");
        assertExprReturns("IIf('test' = 0, 1, 2)", "2");
        assertExprReturns("IIf('test' = NULL, 1, 2)", "2");
        assertExprReturns("IIf(NULL = 'test', 1, 2)", "2");
        assertExprReturns("IIf(0 = NULL, 1, 2)", "2");
        assertExprReturns("IIf(NULL = 0, 1, 2)", "2");
    }

    public void testIifTypeInvariance() {
    ...
    public void testIsError()
    {
        ...
        // Test operations
        assertExprReturns(
            "iif (iserror(Sum([Measures].[Unit Sales])/Sum([Measures].[Unit Sales]) - 2)"
            + ", \"is error\", \"not is error\")",
            "not is error");
        ...
        assertQueryReturns(
            ...
            + "member [Measures].[String] as '[Product].[Food].Member_Caption' \n"
            + "member [Measures].[Numeric] as 'Iif([Measures].[String] = 0, NULL, 42)'\n"
            + "member [Measures].[ErrorCheck] as 'Iif(isError([Measures].[Numeric]), 0, [Measures].[Numeric])'\n"
            + "select \n"
            + "{[Measures].[String], [Measures].[ErrorCheck]} on columns\n"
            + "from Sales",
            "Axis #0:\n"
            + "{}\n"
            + "Axis #1:\n"
